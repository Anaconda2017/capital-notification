...
class AcademicDashboardController extends Controller
{
    ...
    public function statistics() {
        ...
        ->with('degrees', json_encode($array ,JSON_NUMERIC_CHECK))
        ->with('bachelor_degrees', json_encode($array1 ,JSON_NUMERIC_CHECK))
        ->with('master_degrees', json_encode($array2 ,JSON_NUMERIC_CHECK))
        ->with('phd_degrees', json_encode($array3 ,JSON_NUMERIC_CHECK));
    }
    ...
    public function masterStatistics() {
        ...
        ->with('degrees', json_encode($array ,JSON_NUMERIC_CHECK))
        ->with('master_degrees', json_encode($array1 ,JSON_NUMERIC_CHECK));
    }
    ...
    public function phdStatistics() {
        ...
        ->with('degrees', json_encode($array ,JSON_NUMERIC_CHECK))
        ->with('phd_degrees', json_encode($array1 ,JSON_NUMERIC_CHECK));
    }
}
