...
class StoreMainRequest extends FormRequest
{
    ...
    {
        return [
            'first_section_first_image' => 'required|mimes:jpg,jpeg,png,svg',
            ...
            'first_section_second_image' => 'required|mimes:jpg,jpeg,png,svg',
            ...
            'first_section_third_image' => 'required|mimes:jpg,jpeg,png,svg',
            ...
            'last_section_image' =>'required|mimes:jpg,jpeg,png,svg',
