                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body pl-0">
                            <div id="piechart" class="pieChartJs"></div>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card text-center">
                                    <div class="card-content">
                                        <div class="card-body py-1">
                                            ...
                                            <div class="text-muted line-ellipsis">عدد البكالوريوس</div>
                                            <h3 class="mb-0">{{ $numberOfBachelorUsers }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        var chart3 = new google.visualization.PieChart(document.getElementById('phd_line_chart'));
        chart3.draw(data3);
        }
