...
@php $pageTitle = 'حركه ملفات الماجستير'; @endphp
...
@section('content')
    ...
    <div class="card px-2">
        ...
        <div class="table-responsive">
            <table class="table table-border-right table-striped table-bordered" id="movement-master-users-table">
                <thead>
                    <tr>
                        <th>#</th>
                        ...
                        <th class="mw-120px">البكالوريوس</th>
                        <th class="mw-120px">حاله البكالوريوس</th>
                        <th class="mw-120px">بيان الدرجات</th>
                        <th class="mw-120px">حاله بيان الدرجات</th>
    ...
    <div id="formModalMovementMaster" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title-movement-master mb-0">Add New Record</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <span id="form_result_movement_master"></span>
                    <form method="POST" id="movement-master-form" class="form-horizontal">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="control-label">البكالوريوس : </label>
                                    <div id="bachelor">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="control-label"> حالة البكالوريوس : </label>
                                    <select class="form-control" name="bachelor_status" id="bachelor_status">
                                        <option value="">اختر الحاله</option>
                                        <option value="0">لم يتم القبول</option>
                                        <option value="1">تم القبول</option>
                                    </select>                               
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="control-label">بيان الدرجات : </label>
                                    <div id="degree_transcript">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="control-label"> حالة بيان الدرجات : </label>
                                    <select class="form-control" name="degree_transcript_status" id="degree_transcript_status">
                                        <option value="">اختر الحاله</option>
                                        <option value="0">لم يتم القبول</option>
                                        <option value="1">تم القبول</option>
                                    </select>                               
                        ...
                        <div class="form-group" align="center">
                            <input type="hidden" name="action_movement_master" id="action_movement_master" value="Add" />
                            <input type="hidden" name="hidden_id_movement_master" id="hidden_id_movement_master" />
                            <input type="submit" name="action_button_movement_master" id="action_button_movement_master" class="btn btn-warning" value="Add" />
                        </div>
                    </form>
                </div>
                </div>
    ...
    <div id="confirmModalMovementMaster" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title-movement-master mb-0">Confirmation</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                 <button type="button" name="ok_button_movement_master" id="ok_button_movement_master" class="btn btn-danger">نعم</button>
