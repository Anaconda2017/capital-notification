...
@php $pageTitle = 'حركه ملفات البكالوريوس'; @endphp
...
@section('content')
    ...
    <div class="card px-2">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered" id="movement-bachelor-users-table">
                <thead>
                    <tr>
                        <th>#</th>
                        ...
                        <th class="mw-120px">دبلومه</th>
                        <th class="mw-120px">حاله الدبلومه</th>
                        ...
                        <th class="mw-120px">حاله المدوب</th>
    ...
    <div id="formModalMovementBachelor" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title-movement-bachelor mb-0">Add New Record</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <span id="form_result_movement_bachelor"></span>
                    <form method="POST" id="movement-bachelor-form" class="form-horizontal">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="control-label">دبلومه : </label>
                                    <div id="diploma">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="control-label"> حالة دبلومه : </label>
                                    <select class="form-control" name="diploma_status" id="diploma_status">
                                        <option value="">اختر الحاله</option>
                                        <option value="0">لم يتم القبول</option>
                                        <option value="1">تم القبول</option>
                                    </select>                               
                        ...
                        <div class="form-group" align="center">
                            <input type="hidden" name="action_movement_bachelor" id="action_movement_bachelor" value="Add" />
                            <input type="hidden" name="hidden_id_movement_bachelor" id="hidden_id_movement_bachelor" />
                            <input type="submit" name="action_button_movement_bachelor" id="action_button_movement_bachelor" class="btn btn-warning" value="Add" />
                        </div>
                    </form>
                </div>
                </div>
    ...
    <div id="confirmModalMovementBachelor" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content modal-lg">
                <div class="modal-header">
                    <h4 class="modal-title-movement-bachelor mb-0">Confirmation</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                 <button type="button" name="ok_button_movement_bachelor" id="ok_button_movement_bachelor" class="btn btn-danger">نعم</button>
