...
@php $pageTitle = 'كشف تسجيل الدكتوراه'; @endphp
...
@section('content')
    ...
    <div class="card px-2">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered" id="register-phd-users-table">
                <thead>
                    <tr>
                        <th>#</th>
    ...
    <div id="formModalRegisterPhd" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title-register-phd mb-0">Add New Record</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <span id="form_result_register_phd"></span>
                    <form method="POST" id="register-phd-form" class="form-horizontal">
                        @csrf
                        <div class="row">
                        ...
                        <div class="form-group" align="center">
                            <input type="hidden" name="action_register_phd" id="action_register_phd" value="Add" />
                            <input type="hidden" name="hidden_id_register_phd" id="hidden_id_register_phd" />
                            <input type="submit" name="action_button_register_phd" id="action_button_register_phd" class="btn btn-warning" value="Add" />
                        </div>
                    </form>
                </div>
                </div>
    ...
    <div id="confirmModalRegisterPhd" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title-register-phd mb-0">Confirmation</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                 <button type="button" name="ok_button_register_phd" id="ok_button_register_phd" class="btn btn-danger">نعم</button>
