...
@php $pageTitle = 'تسجيل عملاء البكالوريوس'; @endphp
...
@section('content')
    ...
    <div class="card px-2">
        ...
        <div class="table-responsive">
            <table class="table table-border-right table-striped table-bordered" id="register-bachelor-users-table">
                <thead>
                    <tr>
                        <th>#</th>
                        ...
                        <th class="mw-120px">الدرجه المئويه</th>
    ...
    <div id="formModalRegisterBachelor" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title-register-bachelor mb-0">Add New Record</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <span id="form_result_register_bachelor"></span>
                        <form method="POST" id="register-bachelor-form" class="form-horizontal">
                            @csrf
                            <div class="row">
                            ...
                            <div class="form-group" align="center">
                                <input type="hidden" name="action_register_bachelor" id="action_register_bachelor" value="Add" />
                                <input type="hidden" name="hidden_id_register_bachelor" id="hidden_id_register_bachelor" />
                                <input type="submit" name="action_button_register_bachelor" id="action_button_register_bachelor" class="btn btn-warning" value="Add" />
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div id="confirmModalRegisterBachelor" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title-register-bachelor mb-0">Confirmation</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                 <button type="button" name="ok_button_register_bachelor" id="ok_button_register_bachelor" class="btn btn-danger">نعم</button>
