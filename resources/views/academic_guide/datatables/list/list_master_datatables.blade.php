...
@php $pageTitle = 'كشف عملاء الماجستير'; @endphp
        ...
        <div class="card-header card-header-primary mb-4">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-6 text-right">
                    <button type="button" name="create_record_list_master" id="create_record_list_master" class="btn btn-white btn-round">إنشاء سجل</button>
                </div>
            </div>
        </div>

        <div class="table-responsive">
            <table class="table table-border-right table-striped table-bordered" id="list-master-users-table">
                <thead>
                    <tr>
                        <th>#</th>
                        ...
                        <th class="mw-120px">اسم العميل</th>
    
                        <th class="mw-120px">حاله المرشد</th>     
                        ...
                        <th class="mw-120px">اخر مؤهل دراسي</th>
                        <th class="mw-120px">بلداخر مؤهل دراسي </th>
                        <th class="mw-120px">اسم جامعه اخر مؤهل</th>
                        <th class="mw-120px">اسم كلية اخر مؤهل</th>
                        <th class="mw-120px">اسم قسم اخر مؤهل</th>
                        <th class="mw-120px">عام التخرج</th>
                        <th class="mw-120px">النسبه المئويه</th>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="mw-120px">اخر مؤهل دراسي</th>
                        <th class="mw-120px">بلداخر مؤهل دراسي </th>
                        <th class="mw-120px">اسم جامعه اخر مؤهل دراسي</th>
                        <th class="mw-120px">اسم كلية اخر مؤهل دراسي</th>
                        <th class="mw-120px">اسم قسم اخر مؤهل دراسي</th>
                        <th class="mw-120px">عام التخرج</th>
                        <th class="mw-120px">النسبه المئويه</th>
                        <th class="mw-120px">نظام الدراسه</th>
...
>
        ...
        <div id="formModalListMaster" class="modal fade" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title-list-master mb-0">Add New Record</h4>
                        <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
                        <span id="form_result_list_master"></span>
                        <form method="POST" id="list-master-form" class="form-horizontal">
                            @csrf
                            <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="control-label">حاله المرشد : </label>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="control-label"> اخر مؤهل دراسي: </label>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="control-label">بلد اخر مؤهل دراسي  : </label>
                            ...
                            <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="control-label">عام التخرج : </label>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="control-label" >النسبه المئوية : </label>
                            ...
                            <div class="form-group" align="center">
                                <input type="hidden" name="action_list_master" id="action_list_master" value="Add" />
                                <input type="hidden" name="hidden_id_list_master" id="hidden_id_list_master" />
                                <input type="submit" name="action_button_list_master" id="action_button_list_master" class="btn btn-warning" value="Add" />
                            </div>
                        </form>
                    </div>
                    </div>
        ...
        <div id="confirmModalListMaster" class="modal fade" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title-list-master mb-0">Confirmation</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
                    ...
                    <button type="button" name="ok_button_list_master" id="ok_button_list_master" class="btn btn-danger">نعم</button>
