...
@php $pageTitle = 'تقارير العملاء'; @endphp
...
@section('content')
    ...
    <div class="card px-2">
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <form action="" method="GET" class="row align-items-center">
                        ...
                        @if(request()->has('from'))
                          <div class="col-3"><a href="{{ route('academicGuideListReportsView') }}" class="btn-block btn-round btn btn-danger">Remove</a>
                          </div>
                        @endif
                    </form>
                </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered" id="list-reports-users-table">
                <thead>
                    <tr>
                        <th>اليوم</th>
                        <th>الشهر</th>
