...
@php $pageTitle = 'كشف عملاء البكالوريوس'; @endphp
...
@section('content')
        ...
        <div class="card-header card-header-primary mb-4">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 col-6 text-right">
                    <button type="button" name="create_record_list_bachelor" id="create_record_list_bachelor" class="btn btn-white btn-round">إنشاء سجل</button>
                </div>
            </div>
        </div>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-border-right table-striped table-bordered" id="list-bachelor-users-table">
            <thead>
                <tr>
                    <th>#</th>
    ...
    <div id="formModalListBachelor" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title-list-bachelor mb-0">Add New Record</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <span id="form_result_list_bachelor"></span>
                    <form method="POST" id="list-bachelor-form" class="form-horizontal">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="control-label">اسم المدرسة : </label>
                        ...
                        <div class="form-group" align="center">
                            <input type="hidden" name="action_list_bachelor" id="action_list_bachelor" value="Add" />
                            <input type="hidden" name="hidden_id_list_bachelor" id="hidden_id_list_bachelor" />
                            <input type="submit" name="action_button_list_bachelor" id="action_button_list_bachelor" class="btn btn-warning" value="Add" />
                        </div>
                    </form>
                </div>
                </div>
    ...
    <div id="confirmModalListBachelor" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title-list-bachelor mb-0">Confirmation</h4>
                    <button type="button" class="close m-0 p-0" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                 <button type="button" name="ok_button_list_bachelor" id="ok_button_list_bachelor" class="btn btn-danger">نعم</button>
