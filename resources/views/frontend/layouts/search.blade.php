@if(app()->getLocale() == 'en')
    <div class="col-lg-3 search-sidebar wow fadeInUp"data-wow-delay="100ms" data-wow-duration="2000ms">
        <form id="uni-search-form" action="{{ route('search') }}" method="POST">
            ...
            <div class="mb-20">
                                        <label for="country-list"> Departments:</label>
...
@else
    <div class="col-lg-3  wow fadeInUp"data-wow-delay="100ms" data-wow-duration="2000ms">
        ...
        <div class="search-sidebar" style="margin-top: 35px;">
                                <h5 style="text-align: right;">البحث في الجامعات</h5>            
        <form id="uni-search-form" action="{{ route('search') }}" method="POST">
            @csrf
            <div class="mb-20">
            ...
            <div class="mb-20">
                <label for="country-list" style="float: right !important;"> الدرجه العلميه :</label>
                <br>
                <select name="fac_uni_major_id" class="form-control" id="fac_uni_major_id">
                </select>
            </div>
            ...
            <div class="mb-20">
                                        <label for="country-list"> التخصص:</label>
                                        <select name="department_id" class="form-control" id="department_id">
                                        </select>
                                    </div>
            <div class="form-group mb-3 text-center">
