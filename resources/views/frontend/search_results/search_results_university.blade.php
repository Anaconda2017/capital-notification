            ...
            <section class="course__area pt-120 pb-120">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 wow university-item animate__animated animate__slideInUp" >
                            ...
                            <div class="row gx-0 align-items-center">
                                ...
                                <div class="course__right">
                                    ...
                                    <h3 class="course__title" title="{{ $faculty->en_name }}">
                                        <a>
                                            {{ $faculty->en_name }}
                                        </a>
                                    </h3>
                                    ...
                                    <div class="course__btn">
                                        <a href="{{ route('faculty', [$country->en_slug, $university->en_slug, $faculty->en_slug]) }}"  class="link-btn">
                                            Explore faculty
                                ...
                                <div class="row">
                                    <div class="col-xxl-9 col-xl-9 col-lg-9">
                                        ...
                                        <div class="row">
                                            <!-- <ng-container *ngIf="(destinations  | searchDestination: term) as destinations"> -->
                                                @foreach($university->faculties as $faculty)
                                            <div class="col-lg-6 wow university-ite animate__animated animate__slideInUp" >
                                                <div class="course__item white-bg mb-30 fix">
                                                <div class="row gx-0 align-items-center">
                                                    <div class=" col-3">
                                                    <div class="course__thumb course__thumb-list w-img p-relative fix text-center">
                                                    ...
                                                    <div class="course__right">
                                                        ...
                                                        <h3 class="course__title" title="{{ $faculty->ar_name }}">
                                                            <a>
                                                                {{ $faculty->ar_name }}
                                                            </a>
                                                        </h3>
                                                        ...
                                                        <div class="course__btn">
                                                            <a href="{{ route('faculty', [$country->ar_slug, $university->ar_slug, $faculty->ar_slug]) }}"  class="link-btn">
                                                                تصفح الكلية
                                    ...
                                    <div class="col-xxl-3 col-xl-3 col-lg-3">
                                        <div class="course__sidebar">
                                            <div class="course__sidebar-search mb-50">
                                            <input type="text" class="search_text" placeholder="أبحث في الكليات...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
