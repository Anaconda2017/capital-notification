                              ...
                              <ul id="menu-service-menu" class="menu">
                                @foreach ($otherCategory as $item)
                                    @if($item->id == $subcategory->id)
                                        ...
                                        <li class=" current-menu-item"> <a href="{{ route('protocols' , $item->id) }}" aria-current="page">{{ $item->title }}</a> </li>  
                                    @else 
                        ...
                        <div class="row">  
                           ...
                           <div class="row">
                              ...
                              <div class="pq-accordion-block ">
                                 @foreach ($subcategory->protocols as $key => $item)
