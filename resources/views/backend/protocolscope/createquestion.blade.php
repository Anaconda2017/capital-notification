          ...
          <div class="card">
            ...
            <div class="card-body">
                <div class="basic-form">
                  <form class="col-12" action="{{ route('storequestion') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      <div class="row">
                        ...
                        <div class="form-group col-lg-12 ">
                            <label for=""> Question Flow Chart </label>
                            <div class="input-group">

                                <textarea style="margin-bottom:30px" name="text" class="form-control ckeditor" placeholder="Description" style="min-height: 100px; max-height: 100px;" required>{{ old('text') }}</textarea>
                            </div>
