...
@php $pageTitle = ' Partner Control'; @endphp
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
               ...
               <a href="{{ route('clients.create') }}"><button class="btn light btn-primary ">Add</button></a> 
              </div>
              <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <div class="dropdown ml-auto text-right">
                                    ...
                                    <a class="dropdown-item" href="{{ route('clients.edit', $coupon->id) }}">Update</a>
                                    @if($coupon->status == 1)
                                            <form action="{{ route('clients.destroy', $coupon->id)  }}" method="POST">
                                                {{ method_field('delete') }}
                                                {{ csrf_field() }} 
                                                <button type="submit" class="dropdown-item">Disable</button>
                                            </form>
                                    @else
                                            <form action="{{ route('clientsRecover', $coupon->id)  }}" method="POST">
