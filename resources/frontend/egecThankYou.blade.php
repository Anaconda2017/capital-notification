            ...
            <div class="jumbotron text-center py-3">
                ...
                <div class="row justify-content-center py-4">
                    <div class="col-md-3 text-center">
                        <h4>Email</h4>
                        <p id="email"><a href="mailto:{{ session('user_submitted_email') }}">{{ session('user_submitted_email') }}</a><button class="btn mx-2 p-2" onclick="copyToClipboard('#email')"><i class="far fa-copy"></i></button></p>
                    
                    </div>
                    <div class="col-md-3 text-center">
                        <h4 >Password</h4>
                        <p id="password">{{ session('user_submitted_password') }}<button class="btn" onclick="copyToClipboard('#password')"><i class="far fa-copy"></i></button></p>
                ...
                <p class="lead">
                  <a class="btn btn-primary" href="{{ route('login') }}" role="button">Continue to Login page</a>
                </p>
                @else
                    ...
                    <p class="lead">
                      <a class="btn btn-primary" href="http://digitalbondmena.com/egec_new_new/en/egec-study-first-uae" role="button">Continue to Admmision Request</a>
                    </p>
                @endif    
    ...
    @endsection
        ...
        <section id="thanks-section" class="thanks-section jumbotron text-center bg-white py-3">
            ...
            @if (session('user_submitted_email'))
                ...
                <p class="lead">
                  <a class="btn btn-primary" href="{{ route('login')}}" role="button">اذهب لتسجيل الدخول</a>
                </p>
            @else
                ...
                <p class="lead">
                      <a class="btn btn-primary" href="http://digitalbondmena.com/egec_new_new/ar/egec-study-first-uae" role="button">تابع إلى طلب الالتحاق</a>
                    </p>
