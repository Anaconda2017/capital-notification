                        ...
                        <div class="container">
                            ...
                            <!--End title-->
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a style="color: #8cc63f" href="http://egecmena.com/egec_new/en">Home</a></li>
                                            <li class="breadcrumb-item"><a style="color: #8cc63f" href="">Paper movement</a></li>
                            ...
                            <!--End title-->
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a style="color: #8cc63f" href="http://egecmena.com/egec_new/en">الرئيسية</a></li>
                                            <li class="breadcrumb-item"><a style="color: #8cc63f" href="">حركه الاوراق</a></li>
            ...
            @if($user_movement->passport_status == 0 || $user_movement->secondary_certificate_status == 0 || $user_movement->birth_certificate_status == 0)
                <section class="register-section pt-100 pb-100">
                    <div class="container">
                        ...
                        @endif
                        <div class="register-box" style="box-shadow:6px 5px 8px rgba(0,0,0,0.3;">
                            @if(app()->getLocale() == 'en')
                                <div class="sec-title text-center mb-30">
                                    <h2 class="title mb-10">First paper Information </h2>
                                    <span>Waiting for all Papers to get approved...</span>
                                </div>
                            @else
                                <div class="sec-title text-center mb-30">
                                    <h2 class="title mb-10">المعلومات الورقية الاولى</h2>
                                    <span>في انتظار الموافقة على جميع الأوراق ...</span>
                                </div>
                        	@endif
                                ...
                                <form action="{{ route('submit-first-paper-info') }}" method="POST" enctype="multipart/form-data">    
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12 text-center">
                                             @if(app()->getLocale() == 'en')
                                                <button type="submit" class="readon register-btn"><span class="txt">Upload files</span></button>
                                            @else
                                               <button type="submit" class="readon register-btn"><span class="txt">رفع الملفات</span></button>
                                        	@endif
                                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="register-box" style="box-shadow:6px 5px 8px rgba(0,0,0,0.3;">
                            ...
                            <div class="sec-title text-center mb-30">
                                    ...
                                    <h2 class="title mb-10">Second Paper Information </h2>
                ...
                <section class="register-section pt-100 pb-100">
                    <div class="container">
                        ...
                        <div class="register-box" style="box-shadow:6px 5px 8px rgba(0,0,0,0.3;">
                            ...
                            <div class="sec-title text-center mb-30">
                                @if(app()->getLocale() == 'en')
                                    <h2 class="title mb-10">First Payment Information</h2>
                                    @if($admissionInfo->account_finance_first_image != NULL)
                                        <span>Waiting for Money to get approved...</span>
                                    @endif
                                @else
                                    <h2 class="title mb-10">معلومات الدفعه الاولى من الاموال </h2>
                                    @if($admissionInfo->account_finance_first_image != NULL)
                                        <span>في انتظار الموافقة على المال ...</span>
                                    @endif
                                @endif
                                ...
                                <form action="{{ route('submit-first-money-info') }}" method="POST" enctype="multipart/form-data">    
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12 text-center">
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 text-center">
                                            @if(app()->getLocale() == 'en')
                                                <button type="submit" class="readon register-btn"><span class="txt">Upload file</span></button>
                                            @else
                                               <button type="submit" class="readon register-btn"><span class="txt">رفع الملف</span></button>
                                        	@endif
                                        </div>
                                        </div>
                    ...
                    <section class="register-section pt-100 pb-100">
                        <div class="container">
                            ...
                            <div class="register-box" style="box-shadow:6px 5px 8px rgba(0,0,0,0.3;">
                                ...
                                <div class="sec-title text-center mb-30">
                                    @if(app()->getLocale() == 'en')
                                        <h2 class="title mb-10">Follow up payment information</h2>
                                        @if($admissionInfo->account_finance_first_image != NULL)
                                            <span>Waiting for Money to get approved...</span>
                                        @endif
                                    @else
                                        <h2 class="title mb-10">معلومات دفعه المتابعه</h2>
                                        @if($admissionInfo->account_finance_first_image != NULL)
                                            <span>في انتظار الموافقة على المال ...</span>
                                        @endif
                                    @endif
                    ...
                    <section class="register-section pt-100 pb-100">
                        <div class="container">
                            ...
                            <div class="register-box" style="box-shadow:6px 5px 8px rgba(0,0,0,0.3;">
                                ...
                                <div class="sec-title text-center mb-30">
                                    @if(app()->getLocale() == 'en')
                                        <h2 class="title mb-10">Payment money to submit and open the file</h2>
                                        @if($admissionInfo->account_finance_first_image != NULL)
                                            <span>Waiting for Money to get approved...</span>
                                        @endif
                                    @else
                                        <h2 class="title mb-10">دفعه الاموال لقدم وفتح الملف</h2>
                                        @if($admissionInfo->account_finance_first_image != NULL)
                                            <span>في انتظار الموافقة على المال ...</span>
                                        @endif
                                    @endif
                        ...
                        <div class="container">
                            ...
                            <div class="register-box" style="box-shadow:6px 5px 8px rgba(0,0,0,0.3;">
                                ...
                                <div class="sec-title text-center mb-30">
                                        ...
                                        <h2 class="title mb-10">Amount paid to close the file</h2>
                                        @if($admissionInfo->account_finance_first_image != NULL)
                                            <span>Waiting for Money to get approved...</span>
                                        @endif
                                </div>
                    ...
                    <section class="register-section pt-100 pb-100">
                        <div class="container">
                            ...
                            <div class="register-box" style="box-shadow:6px 5px 8px rgba(0,0,0,0.3;">
                                ...
                                <div class="sec-title text-center mb-30">
                                    <h2 class="title mb-10">All Receipts</h2>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <img src="{{ asset('egec_new/movement/' . $admissionInfo->account_finance_first_image) }}" width="270px" height="100px">
                                ...
                                @if($admissionInfo->account_finance_second_image != NULL)
                                    <div class="row clearfix">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <img src="{{ asset('egec_new/movement/' . $admissionInfo->account_finance_second_image) }}" width="270px" height="100px">
                                ...
                                @if($admissionInfo->account_finance_third_image != NULL)
                                    <div class="row clearfix">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <img src="{{ asset('egec_new/movement/' . $admissionInfo->account_finance_third_image) }}" width="270px" height="100px">
                                ...
                                @if($admissionInfo->account_finance_fourth_image != NULL)
                                    <div class="row clearfix">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <img src="{{ asset('egec_new/movement/' . $admissionInfo->account_finance_fourth_image) }}" width="270px" height="100px">
                                ...
                                <form action="{{ route('submit-first-paper-info') }}" method="POST" enctype="multipart/form-data">    
                                    ...
                                    <div class="row clearfix">
                                        <div class="form-group col-lg-6">
                                            ...
                                            @if(isset($user_movement))
                                                @if($user_movement->passport !== NULL)
                                                    <img src="{{ asset('egec_new/movement/' . $user_movement->passport) }}" width="270px" height="100px">
                                                @endif
                                            @endif
                                            @if($errors->has('passport'))
                                                <span class="text-danger">{{ $errors->first('passport') }}</span>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            @if(isset($user_movement))
                                                @if($user_movement->secondary_certificate !== NULL)
                                                    <img src="{{ asset('egec_new/movement/' . $user_movement->secondary_certificate) }}" width="270px" height="100px">
                                                @endif
                                            @endif
                                            @if($errors->has('secondary_certificate'))
                                                <span class="text-danger">{{ $errors->first('secondary_certificate') }}</span>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            @if(isset($user_movement))
                                                @if($user_movement->birth_certificate !== NULL)
                                                    <img src="{{ asset('egec_new/movement/' . $user_movement->birth_certificate) }}" width="270px" height="100px">
                                                @endif
                                            @endif
                                            @if($errors->has('birth_certificate'))
                                                <span class="text-danger">{{ $errors->first('birth_certificate') }}</span>
                                ...
                                <form action="{{ route('submit-second-paper-info') }}" method="POST" enctype="multipart/form-data">    
                                    ...
                                    <div class="row clearfix">
                                        <div class="form-group col-lg-6">
                                            ...
                                            @if(isset($user_movement))
                                                @if($user_movement->bachelor !== NULL)
                                                    <img src="{{ asset('egec_new/movement/' . $user_movement->bachelor) }}" width="270px" height="100px">
                                                @endif
                                            @endif
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            @if(isset($user_movement))
                                                @if($user_movement->degree_transcript !== NULL)
                                                    <img src="{{ asset('egec_new/movement/' . $user_movement->degree_transcript) }}" width="270px" height="100px">
                                                @endif
                                            @endif
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            @if(isset($user_movement))
                                                @if($user_movement->authorization !== NULL)
                                                    <img src="{{ asset('egec_new/movement/' . $user_movement->authorization) }}" width="270px" height="100px">
                                                @endif
                                            @endif
                                            @if($errors->has('authorization'))
                                                <span class="text-danger">{{ $errors->first('authorization') }}</span>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            @if(isset($user_movement))
                                                @if($user_movement->image !== NULL)
                                                    <img src="{{ asset('egec_new/movement/' . $user_movement->image) }}" width="270px" height="100px">
                                                @endif
                                            @endif
                                            @if($errors->has('image'))
                                                <span class="text-danger">{{ $errors->first('image') }}</span>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            @if(isset($user_movement))
                                                @if($user_movement->last_document !== NULL)
                                                    <img src="{{ asset('egec_new/movement/' . $user_movement->last_document) }}" width="270px" height="100px">
                                                @endif
                                            @endif
                                            @if($errors->has('last_document'))
                                                <span class="text-danger">{{ $errors->first('last_document') }}</span>
                                ...
                                <form action="{{ route('submit-second-paper-info') }}" method="POST" enctype="multipart/form-data">    
                                    ...
                                    <div class="row clearfix">
                                        <div class="form-group col-lg-6">
                                            ...
                                            @if(isset($user_movement))
                                                @if($user_movement->master !== NULL)
                                                    <img src="{{ asset('egec_new/movement/' . $user_movement->master) }}" width="270px" height="100px">
                                                @endif
                                            @endif
