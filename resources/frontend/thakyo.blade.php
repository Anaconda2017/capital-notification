            ...
            <div class="jumbotron text-center py-3">
                ...
                <div class="row justify-content-center py-4">
                    <div class="col-md-3 text-center">
                        <h4>Email</h4>
                        <p id="email">
                            <a href="mailto:{{ session('user_submitted_email') }}">{{ session('user_submitted_email') }}</a>
                    ...
                    <div class="col-md-3 text-center">
                        <h4 >Password</h4>
                        <p id="password">{{ session('user_submitted_password') }}
                ...
                @else
                    ...
                    <p class="lead">
                      <a class="btn btn-primary" href="http://digitalbondmena.com/egec_new_new/en/study-uae" role="button">Continue to Admmision Request</a>
                    </p>
                @endif    
    ...
    @endsection
        ...
        <section id="thanks-section" class="thanks-section jumbotron text-center bg-white py-3">
            ...
            @else
                ...
                <p class="lead">
                      <a class="btn btn-primary" href="http://digitalbondmena.com/egec_new_new/ar/study-uae" role="button">تابع إلى طلب الالتحاق</a>
                    </p>
